...
public sealed class TrayApp : ApplicationContext
{
    ...
    private const string RunName = "LayoutFix";
    ...
    public TrayApp()
    {
        ...
        {
            Icon = _iconOn,
            Text = "LayoutFix — загрузка словарей…",
            Visible = true,
        ...
        {
            MessageBox.Show("Не удалось установить хук клавиатуры:\n" + ex.Message, "LayoutFix", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ExitThread();
            return;
        }
    ...
    private ContextMenuStrip BuildMenu()
    {
        ...
        _miStatus = new ToolStripMenuItem("LayoutFix") { Enabled = false };
    ...
    private void UpdateUi()
    {
        ...
        _icon.Text = !_dicts.IsLoaded ? "LayoutFix — загрузка словарей…"
                   : on ? $"LayoutFix — работает ({hk}: переключить/отменить)" : "LayoutFix — выключен";
        _miStatus.Text = _dicts.IsLoaded ? $"LayoutFix v{Version}" : "LayoutFix — загрузка словарей…";
